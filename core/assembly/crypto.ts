...
export namespace Crypto {
  /**
   * @description Computes the BLAKE2 128-bit hash on the given input buffer.
   */
  ...
  /**
   * @description Computes the BLAKE2 256-bit hash on the given input buffer.
   */
  ...
  /**
   * @description Computes the KECCAK 256-bit hash on the given input buffer.
   */
  ...
  /**
   * @description Computes the SHA2 256-bit hash on the given input buffer.
   */
